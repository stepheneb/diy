...
module OtrunkSystem
 ...
 # UUIDs are needed for proper OTrunk data persistence.
 # This should normally only be run when a runnable object
 # is first created with a before_create filter method 
  def generate_uuid
